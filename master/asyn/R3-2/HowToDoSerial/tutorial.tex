...
\item EPICS modules/soft/asyn version 3.2 or higher.
\end{itemize}
...
use the End-Or-Identify (EOI) line to delimit messages.
\end{description}
...
\$(P), \$(L) and \$(A) are used to specify the record name prefix,
...
a device support database description in dbd/ and a device support
database in db/.
...
definition files for your instrument and for the SYN drivers. There
...
\subsection{Add the device support database file to the application}

The makeBaseApp.pl script creates \textit{xxx}\texttt{App/Db/Makefile}.
Add a line for the device support database file:

\begin{lyxcode}
DB\_INSTALLS~+=~devAB300.db
\end{lyxcode}
...
\begin{lyxcode}
dbLoadRecords(\char`\"{}../../db/devAB300.db\char`\"{},\char`\"{}P=AB300:,L=0,A=0\char`\"{})
\end{lyxcode}
...
\#\#\#~~EPICS~R3.14.6~\$\$Name:~~\$\$~\$\$Date:~2004/06/21~18:03:58~\$\$~\\
\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#~\\
Starting~iocInit~\\
...
\begin{lyxcode}
medm~-x~-macro~\char`\"{}P=AB300,R=Test,PORT=L0,ADDR=0\char`\"{}~asynRecord.adl\end{lyxcode}
